...
import MiriamAvatar from "@/components/MiriamAvatar";
      ...
      <div className="min-h-screen bg-background pb-20">
        ...
        <div className="bg-gradient-to-br from-primary/15 via-primary/5 to-background px-5 pt-6 pb-5">
          ...
          <div className="flex items-center gap-4 mb-5">
            <MiriamAvatar size="md" isSpeaking={speakingIdx !== null} isListening={isListening} />
            <div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <MiriamAvatar size="sm" isSpeaking={speakingIdx !== null} isListening={isListening} />
            </div>
            <div>
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
              ...
              <div className={`max-w-[85%] flex flex-col gap-1 ${m.role === "user" ? "items-end" : "items-start"}`}>
                {m.role === "assistant" && (
                  <div className="flex items-center gap-1.5 mb-0.5">
                    <MiriamAvatar size="sm" isSpeaking={speakingIdx === messages.indexOf(m)} className="!w-5 !h-5" />
        ...
        {loading && messages[messages.length - 1]?.role !== "assistant" && (
          <div className="flex justify-start">
            <div className="flex items-center gap-2">
              <MiriamAvatar size="sm" isSpeaking={false} isListening={false} className="!w-5 !h-5" />
