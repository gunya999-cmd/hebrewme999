...
export const STREET_TALK_CATEGORIES: Array<{ id: StreetTalkCategory; title: string; desc: string; mark: string }> = [
  ...
  { id: "airport", title: "Аэропорт", desc: "регистрация, безопасность, паспорт", mark: "✈" },
...
export const STREET_TALK_PHRASES: StreetTalkPhrase[] = [
  ...
  { id: "st-111", category: "airport", hebrew: "לאן אתה טס?", transcription: "ле-ан ата тас?", russian: "Куда вы летите?", context: "вопрос сотрудника при регистрации", tone: "neutral" },
  { id: "st-112", category: "airport", hebrew: "אני טס לרומא", transcription: "ани тас ле-Рома", russian: "Я лечу в Рим", context: "ответ пассажира при регистрации", tone: "neutral" },
  { id: "st-113", category: "airport", hebrew: "יש לך מזוודה לשלוח?", transcription: "еш леха мизвада лишлоах?", russian: "У вас есть багаж для сдачи?", context: "вопрос сотрудника при регистрации", tone: "neutral" },
  { id: "st-114", category: "airport", hebrew: "כן, מזוודה אחת", transcription: "кен, мизвада ахат", russian: "Да, один чемодан", context: "ответ пассажира при регистрации", tone: "neutral" },
  { id: "st-115", category: "airport", hebrew: "ארזת את המזוודה בעצמך?", transcription: "аразта эт а-мизвада бе-ацмеха?", russian: "Вы сами упаковали чемодан?", context: "вопрос службы безопасности", tone: "neutral" },
  { id: "st-116", category: "airport", hebrew: "כן, ארזתי אותה בעצמי", transcription: "кен, аразти ота бе-ацми", russian: "Да, я упаковал его сам", context: "ответ службе безопасности", tone: "neutral" },
  { id: "st-117", category: "airport", hebrew: "המזוודה הייתה איתך כל הזמן?", transcription: "а-мизвада айта итха коль а-зман?", russian: "Чемодан всё время был при вас?", context: "вопрос службы безопасности", tone: "neutral" },
  { id: "st-118", category: "airport", hebrew: "כן, היא הייתה איתי כל הזמן", transcription: "кен, и айта ити коль а-зман", russian: "Да, он всё время был при мне", context: "ответ службе безопасности", tone: "neutral" },
  { id: "st-119", category: "airport", hebrew: "מישהו נתן לך משהו להעביר?", transcription: "мишеу натан леха машеу леаавир?", russian: "Кто-нибудь дал вам что-то передать?", context: "вопрос службы безопасности", tone: "neutral" },
  { id: "st-120", category: "airport", hebrew: "לא, אף אחד לא נתן לי כלום", transcription: "ло, аф эхад ло натан ли клум", russian: "Нет, никто ничего мне не передавал", context: "ответ службе безопасности", tone: "neutral" },
  { id: "st-121", category: "airport", hebrew: "יש לך נוזלים בתיק?", transcription: "еш леха нозлим ба-тик?", russian: "У вас есть жидкости в сумке?", context: "вопрос при досмотре ручной клади", tone: "neutral" },
  { id: "st-122", category: "airport", hebrew: "יש לי רק בקבוק קטן", transcription: "еш ли рак бакбук катан", russian: "У меня только маленькая бутылка", context: "ответ при досмотре ручной клади", tone: "neutral" },
  { id: "st-123", category: "airport", hebrew: "יש לך מחשב נייד?", transcription: "еш леха махшев наяд?", russian: "У вас есть ноутбук?", context: "вопрос при досмотре", tone: "neutral" },
  { id: "st-124", category: "airport", hebrew: "כן, הוא בתיק שלי", transcription: "кен, у ба-тик шели", russian: "Да, он в моей сумке", context: "ответ при досмотре", tone: "neutral" },
  { id: "st-125", category: "airport", hebrew: "תוציא בבקשה את המחשב מהתיק", transcription: "тоци бевакаша эт а-махшев ме-а-тик", russian: "Достаньте, пожалуйста, ноутбук из сумки", context: "указание службы безопасности", tone: "neutral" },
  { id: "st-126", category: "airport", hebrew: "צריך להוריד את החגורה?", transcription: "царих леорид эт а-хагура?", russian: "Нужно снять ремень?", context: "вопрос пассажира при досмотре", tone: "neutral" },
  { id: "st-127", category: "airport", hebrew: "כן, ותוריד גם את המעיל", transcription: "кен, ве-торид гам эт а-меиль", russian: "Да, и снимите также куртку", context: "ответ сотрудника службы безопасности", tone: "neutral" },
  { id: "st-128", category: "airport", hebrew: "אפשר לפתוח את התיק?", transcription: "эфшар лифтоах эт а-тик?", russian: "Можно открыть вашу сумку?", context: "вопрос службы безопасности", tone: "neutral" },
  { id: "st-129", category: "airport", hebrew: "כן, בבקשה", transcription: "кен, бевакаша", russian: "Да, пожалуйста", context: "ответ пассажира при досмотре", tone: "friendly" },
  { id: "st-130", category: "airport", hebrew: "מה מטרת הנסיעה?", transcription: "ма матарат а-несиа?", russian: "Какова цель поездки?", context: "вопрос на паспортном контроле", tone: "neutral" },
  { id: "st-131", category: "airport", hebrew: "אני נוסע לחופשה", transcription: "ани носе ле-хуфша", russian: "Я еду в отпуск", context: "ответ на паспортном контроле", tone: "neutral" },
  { id: "st-132", category: "airport", hebrew: "כמה זמן תישאר במדינה?", transcription: "кама зман тишаэр ба-медина?", russian: "Как долго вы останетесь в стране?", context: "вопрос на паспортном контроле", tone: "neutral" },
  { id: "st-133", category: "airport", hebrew: "אני אשאר שבוע", transcription: "ани эшаэр шавуа", russian: "Я останусь на неделю", context: "ответ на паспортном контроле", tone: "neutral" },
  { id: "st-134", category: "airport", hebrew: "איפה תשהה?", transcription: "эйфо тишеэ?", russian: "Где вы будете проживать?", context: "вопрос на паспортном контроле", tone: "neutral" },
  { id: "st-135", category: "airport", hebrew: "אני אשאר במלון במרכז העיר", transcription: "ани эшаэр бе-малон бе-мерказ а-ир", russian: "Я буду жить в отеле в центре города", context: "ответ на паспортном контроле", tone: "neutral" },
  { id: "st-136", category: "airport", hebrew: "יש לך כרטיס חזרה?", transcription: "еш леха картис хазара?", russian: "У вас есть обратный билет?", context: "вопрос на паспортном контроле", tone: "neutral" },
  { id: "st-137", category: "airport", hebrew: "כן, הנה הכרטיס", transcription: "кен, инэ а-картис", russian: "Да, вот билет", context: "ответ на паспортном контроле", tone: "neutral" },
  { id: "st-138", category: "airport", hebrew: "אתה נוסע לבד?", transcription: "ата носе левад?", russian: "Вы путешествуете один?", context: "вопрос на паспортном контроле", tone: "neutral" },
  { id: "st-139", category: "airport", hebrew: "לא, אני נוסע עם המשפחה", transcription: "ло, ани носе им а-мишпаха", russian: "Нет, я путешествую с семьёй", context: "ответ на паспортном контроле", tone: "neutral" },
  { id: "st-140", category: "airport", hebrew: "אפשר לראות את ההזמנה למלון?", transcription: "эфшар лирот эт а-азмана ла-малон?", russian: "Можно посмотреть бронь отеля?", context: "вопрос на паспортном контроле", tone: "neutral" },
  { id: "st-141", category: "airport", hebrew: "כן, ההזמנה בטלפון שלי", transcription: "кен, а-азмана ба-телефон шели", russian: "Да, бронь в моём телефоне", context: "ответ на паспортном контроле", tone: "neutral" },
