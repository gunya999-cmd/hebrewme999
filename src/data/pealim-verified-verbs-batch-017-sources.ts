...
export const PEALIM_VERIFIED_BATCH_017_SOURCES: PealimVerbBatchSource[] = [
  ...
  },
  {
    ...
    frequencyRank: 325,
    tier: "top_conversational_350",
    infinitive_hebrew: "לִבְחוֹן",
    infinitive_plain: "לבחון",
    transcription_ru: "ливх о н",
    translation_ru: "проверять; экзаменовать; рассматривать",
    root: "ב-ח-נ",
    binyan: "פעל",
    source: "pealim",
    sourceUrl: "https://www.pealim.com/ru/search/?q=%D7%9C%D7%91%D7%97%D7%95%D7%9F",
    verificationStatus: "needs_full_conjugation_entry"
  },
  {
    id: "pv-0326",
