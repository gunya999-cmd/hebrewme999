...
function getVerbDropCategory(translation: string): VerbDropCategory {
  ...
  if (hasAny(text, ["болеть", "лечить", "выздорав", "дышать", "умер", "умирать", "ранить", "повред", "ломать", "сломать", "болезн", "здоров", "рвать", "тошн", "кров", "пахнуть", "смотреть", "видеть", "слышать", "трогать", "ощущать", "есть", "пить", "спать", "просып", "уставать"] )) {
    return "body";
  }
